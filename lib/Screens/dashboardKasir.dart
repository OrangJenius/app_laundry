...
class DashboardKasirScreen extends StatefulWidget {
  ...
  const DashboardKasirScreen({
    super.key,
    required this.selectedStoreId,
  });

  @override
  _DashboardKasirScreenState createState() => _DashboardKasirScreenState();
}
...
class _DashboardKasirScreenState extends State<DashboardKasirScreen> {
  ...
  @override
  void didUpdateWidget(covariant DashboardKasirScreen oldWidget) {
